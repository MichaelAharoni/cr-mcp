...
export const MARK_COMMENTS_DICTIONARY = {
  DESCRIPTION:
    'Mark GitHub PR comments as handled by replying with a resolution summary and adding a reaction, CAN NOT BE RUN WITHOUT AN EXPLICIT REQUEST FROM THE USER',
